...
access_info() {
    ...
    echo "    -- -L 6443:${cp_ip}:6443 -L 50000:${cp_ip}:50000 -N"
    echo ""
    echo "--------------------------------------------------------------------------------"
    ...
    echo ""
    echo ">>> Talos (talosctl)"
    echo "    talosctl -n 127.0.0.1 -e 127.0.0.1 dashboard"
    echo ""
    echo ">>> Kubernetes (kubectl)"
    echo "    # Ensure your kubeconfig points to localhost:6443"
    echo "    kubectl --server=https://127.0.0.1:6443 get nodes"
    echo ""
    echo "================================================================================"
    echo ""
}
